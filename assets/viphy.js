...
var topics = ["Richard Pryor", "Bill Hicks", "Dave Chapelle", "Anthony Jeselnik", "George Carlin", "Chris Rock", "Eddie Murphy", "Bill Murray"];
...
$(document).on("click", ".btn", function() {
  ...
  var params = {
    q: query,
    limit: 15,
    api_key: "DdFWWWKTmNrn5Sr01BEdZR03f4EqCYaW",
    fmt: "json"
  };
